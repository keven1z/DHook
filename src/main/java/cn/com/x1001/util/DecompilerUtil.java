...
public class DecompilerUtil {
    ...
    private static String getDecompilerString(byte[] bytes, String className) throws Exception {
    ...
    private static String matchStringByRegularExpression(String line) {
    ...
    public static String getClassString(byte[] classBytes,String className) throws Exception {
        String test = getDecompilerString(classBytes, className);
        StringBuilder stringBuilder = new StringBuilder();
        for (String line : test.split("\n")) {
            String matched = DecompilerUtil.matchStringByRegularExpression(line);
            stringBuilder.append(matched).append(System.lineSeparator());
